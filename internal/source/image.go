...
func (i *Image) Unpack(ctx context.Context, catalog *catalogdv1beta1.CatalogSource) (*Result, error) {
...
func (i *Image) ensureUnpackPod(ctx context.Context, catalog *catalogdv1beta1.CatalogSource, pod *corev1.Pod) (controllerutil.OperationResult, error) {
...
func (i *Image) getDesiredPodApplyConfig(catalog *catalogdv1beta1.CatalogSource) *applyconfigurationcorev1.PodApplyConfiguration {
