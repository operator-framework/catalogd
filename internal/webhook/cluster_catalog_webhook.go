...
func (r *ClusterCatalog) Default(ctx context.Context, obj runtime.Object) error {
	...
	catalog, ok := obj.(*v1.ClusterCatalog)
	if !ok {
	...
	catalog.Labels[v1.MetadataNameLabel] = catalog.GetName()
	log.Info("default", v1.MetadataNameLabel, catalog.Name, "labels", catalog.Labels)
