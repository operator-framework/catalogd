...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *CatalogSourceSource) DeepCopyInto(out *CatalogSourceSource) {
	*out = *in
	if in.Image != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new CatalogSourceSource.
func (in *CatalogSourceSource) DeepCopy() *CatalogSourceSource {
	if in == nil {
		return nil
	}
	out := new(CatalogSourceSource)
	in.DeepCopyInto(out)
	return out
}
