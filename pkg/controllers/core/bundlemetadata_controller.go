...
//+kubebuilder:rbac:groups=core.catalogd.io,resources=bundlemetadata,verbs=get;list;watch;create;update;patch;delete
//+kubebuilder:rbac:groups=core.catalogd.io,resources=bundlemetadata/status,verbs=get;update;patch
//+kubebuilder:rbac:groups=core.catalogd.io,resources=bundlemetadata/finalizers,verbs=update
