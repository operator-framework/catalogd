...
```yaml
  status:
    .
    .
    baseURL: https://catalogd-catalogserver.olmv1-system.svc/catalogs/operatorhubio/api/
    resolvedSource:
      image:
...
`https://catalogd-catalogserver.olmv1-system.svc/catalogs/operatorhubio/api/v1/all`.
