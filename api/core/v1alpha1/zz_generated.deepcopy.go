...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *CatalogURLs) DeepCopyInto(out *CatalogURLs) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new CatalogURLs.
func (in *CatalogURLs) DeepCopy() *CatalogURLs {
	if in == nil {
		return nil
	}
	out := new(CatalogURLs)
