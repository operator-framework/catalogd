...
#  ./asciidemo-tools/generate-gif.sh catalogd-kubecon2023-demo.sh catalogd-kubecon2023-demo.gif
...
function run() {
    ...
    typeline -x "# exercise the 'packages' interface and then display details on one package"
    ...
    typeline -x "# exercise the 'bundlemetadata' interface and then display details on one bundle's metadata"
